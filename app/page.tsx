...
export default function Home() {
  ...
  const initialMessagesGPT: Message[] = [
    { id: 'tb_custom_prompt', role: 'user', content: `please find vulnerabilities in the following smart contract, all responses should be formatted in html using h1,p,ul,li make sure not to use backticks indicating codeblocks. Format like a professional audit report from a web3 audit company` },
